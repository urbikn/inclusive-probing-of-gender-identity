...
def main():
    ...
    argparser.add_argument('--dataset',  type=str, default='dataset', help='Path to dataset ')
    argparser.add_argument('--dataset_embedding',  type=str, default='dataset_embedding', help='Path to dataset containing embeddings')
    ...
    dataset_embeddings = datasets.load_from_disk(args.dataset_embedding)

    labels = ['cis woman', 'cis man', 'trans man', 'trans woman', 'non-binary']
    label_to_id = {label: i for i, label in enumerate(labels)}
    id_to_label = {i: label for i, label in enumerate(labels)}

    dataset = merge_datasets(dataset, dataset_embeddings, label_to_id)
